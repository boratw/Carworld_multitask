...
LOG_DIR = "data/dqn_ol1/trial1/"
log_file = open(LOG_DIR + "log.txt", "wt")

sess = tf.Session()
saver = tf.train.Saver(max_to_keep=0)
log_file.write("Episode\tReward\tStep\tValue_Score\tState_Score\tQvalue\tQvalue_Std\tQvalue_Loss\tState_Loss\n")
...
# (num of obejct x3) (reward x3) (steering addition x2)
tasks = [
    [ [ 0, 1, 8 ], [ 0., 10., -1.], [0.2, -0.2] ],
    [ [ 0, 8, 1 ], [ 0., -1., 10.], [0.2, -0.2] ],
    [ [ 0, 8, 1 ], [ 0., -1., 10.], [0.05, -0.2] ]
]
    ...
    for cur_task in tasks:
        ...
        for episode in range(1, 1001):
            ...
            for play in range(8):
                ...
                #print("Batch " + str(play) + " Step " + str(step) + " Reward " + str(batch_reward) + " Score " + str(batch_score) +  " Inventory : " + str(agent.inventory))
            ...
            cur_score_v /= 8
            cur_score_s /= 8
            print("Epoch " + str(episode) + " Reward : " + str(cur_reward) + " Score_S : " + str(cur_score_s) + " Score_V : " + str(cur_score_v))
            ...
            print("Epoch " + str(episode) + " Qvalue : " + str(q1) + " Std : " + str(qs1) + " Q_Loss : " + str(ql1) + " S_Loss : " + str(sl1))


            log_file.write(str(episode) + "\t" +
                str(cur_reward) + "\t" + str(cur_step / cur_success_batch if cur_success_batch != 0 else 0.) +  "\t" + str(cur_score_v) +  "\t" + str(cur_score_s) +  "\t" + str(q1) + "\t" + str(qs1) + "\t" + str(ql1) + "\t" + str(sl1) + "\n")
            #if episode % 100 == 0:
