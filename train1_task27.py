...
log_file.write("Episode\tReward\tStep\tQvalue\tQvalue_Std\tQvalue_Loss\tState_Loss\n")
...
with sess.as_default():
    ...
    for taski, cur_task in enumerate(tasks):
        ...
        for episode in range(1, 501):
            ...
            log_file.write(str(taski) + "\t" + str(episode) + "\t" +
                str(cur_reward) + "\t" + str(cur_step / cur_success_batch if cur_success_batch != 0 else 0.) +  "\t" + str(q1) + "\t" + str(qs1) + "\t" + str(ql1) + "\t" + str(sl1) + "\n")
